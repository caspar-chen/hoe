...
public class NumberHoe {
    ...
    private static final Pattern PATTERN_POSITIVE_INTEGER = Pattern.compile("[1-9]\\d*");
    private static final Pattern PATTERN_NON_POSITIVE_INTEGER = Pattern.compile("-[1-9]\\d*|0*");
    private static final Pattern PATTERN_NEGATIVE_INTEGER = Pattern.compile("-[1-9]\\d*");
    private static final Pattern PATTERN_NONE_NEGATIVE_INTEGER = Pattern.compile("[1-9]\\d*|0");
    ...
    public static boolean isNonPositiveInteger(String str) {
        return PATTERN_NON_POSITIVE_INTEGER.matcher(str).matches();
    }
    ...
    public static boolean isNegativeInteger(String str) {
        return PATTERN_NEGATIVE_INTEGER.matcher(str).matches();
    }
    ...
    public static boolean isNonNegativeInteger(String str) {
        return PATTERN_NONE_NEGATIVE_INTEGER.matcher(str).matches();
    }
